  ...
  return (
    <div className="w-full flex justify-center items-start gap-12 py-16 max-w-[1296px] mx-auto max-[900px]:flex-col max-[900px]:items-stretch">
      ...
      <div className="flex-1 min-w-[320px] max-w-[500px]">
        <div className="text-[40px] font-bold font-['Noto_Sans_KR'] text-black mb-4 max-[720px]:text-[28px]">
          AI Learning, Real User Stories
        </div>
        <div className="text-[18px] font-medium font-['Noto_Sans_KR'] text-gray-600 mb-6">
          Discover how people from all backgrounds use our AI learning platform to achieve their
          goals. Read real reviews from students, researchers, and professionals.
        </div>
        <a
          href="#"
          className="text-[#2878BE] hover:underline text-[17px] font-medium font-['Noto_Sans_KR'] flex items-center w-fit"
        >
          Learn more
          <svg
            className="ml-1"
