...
function Content2() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        {...fadeInUpImg}
        className="flex flex-col w-1/2 gap-2 justify-between h-full max-[900px]:w-full max-[900px]:gap-1"
      >
        {/* AI 라벨링 카드 */}
        <div className="p-0 flex flex-row items-center gap-8 max-[600px]:flex-col max-[600px]:items-start">
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[16px] text-gray-600">
              데이터에 의미를 부여하는 첫 단계입니다. SAI의 직관적인 인터페이스로 누구나 쉽게
              데이터를 분류하고 라벨링할 수 있어요.
            </div>
          </div>
          <img src={content12} alt="AI 라벨링" className="w-56 h-56 object-contain aspect-square" />
        </div>
        {/* AI 학습 카드 */}
        <div className="p-0 flex flex-row items-center gap-8 max-[600px]:flex-col max-[600px]:items-start">
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[16px] text-gray-600">
              라벨링된 데이터로 AI 모델을 학습시켜보세요. SAI가 최적의 학습 방법을 제안하고,
              실시간으로 학습 과정을 확인할 수 있습니다.
            </div>
          </div>
          <img src={content13} alt="AI 학습" className="w-56 h-56 object-contain aspect-square" />
        </div>
        {/* 결과 추출 카드 */}
        <div className="p-0 flex flex-row items-center gap-8 max-[600px]:flex-col max-[600px]:items-start">
          <div className="flex-1 min-w-0">
            ...
            <div className="text-[16px] text-gray-600">
              학습된 AI 모델의 결과를 쉽게 확인하고 활용할 수 있습니다. SAI가 자동으로 분석 결과를
              시각화하여 보여드려요.
            </div>
          </div>
          <img src={content14} alt="결과 추출" className="w-56 h-56 object-contain aspect-square" />
        </div>
      </motion.div>
