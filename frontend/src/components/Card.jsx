...
function Card({ title, description, image, alt, borderBottom = true, link = '#' }) {
  return (
    <div className={`flex gap-4 items-start ${borderBottom ? 'border-b pb-4' : ''}`}>
      ...
      <div className="w-1/3 flex-shrink-0 h-[180px] flex items-center justify-center bg-gray-200 shadow-md select-none">
