...
namespace SAI.App.Forms.Dialogs
{
    public partial class DialogNotion : Form, IAiFeedbackView, IAiNotionView
    {
        ...
        public string CodeText => Path.GetFullPath(Path.Combine(baseDir, @"..\\..\\Application\\Python\\scripts\\train_script.py"));
        //log 사진 경로
        public string LogImagePath => Path.GetFullPath(Path.Combine(baseDir, @"..\\..\\Application\\Python\\runs\\detect\\train\\results.png"));
        //무슨 사진이 결과 사진인지?
