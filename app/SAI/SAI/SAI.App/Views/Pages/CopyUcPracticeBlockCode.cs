...
{
    public partial class CopyUcPracticeBlockCode : UserControl, IUcShowDialogView, IBlocklyView, IPracticeInferenceView
    {
        ...
        public CopyUcPracticeBlockCode(IMainView view)
        {
            InitializeComponent();
