...
namespace SAI.SAI.App.Views.Pages
{
    partial class UcTutorialBlockCode
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tpContentError.Controls.Add(this.lbMissingType);
			this.tpContentError.Controls.Add(this.lbErrorMessage);
			...
			this.tpErrorHeader.Controls.Add(this.lbErrorType);
