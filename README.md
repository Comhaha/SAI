...
##### 2. AI-blocks
: AI모델 학습을 위한 블록코딩 단계별 학습 흐름 가이드 제공
...
## 기술적 특징
1. **많은 사용자**가 동일한 환경에서 서비스 이용할 수 있습니다.

: 사용자 PC의 GPU (혹은 CPU)를 사용하여 AI 학습과 추론을 진행합니다. 

![동일한_환경에서_이용](/uploads/c4567211e274cd066f6a204190bebc40/동일한_환경에서_이용.png)

2. **쉽고, 간단하게** AI 모델 구조와 성능을 체험할 수 있습니다. 

: 사용자가 간단한 조정으로 AI 모델의 성능 변화를 이해할 수 있습니다. 

✅기본 제공 데이터셋 선정 기준: 파라미터 조정 이후 뚜렷한 성능변화가 발생하는지의 여부

![성능](/uploads/9abc3fe0a6792a3c6626b09011a25d22/성능.png)
