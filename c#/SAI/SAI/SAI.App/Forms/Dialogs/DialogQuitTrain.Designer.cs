namespace SAI.SAI.App.Forms.Dialogs
{
	partial class DialogQuitTrain
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "정말 학습을 중단하시겠습니까?";
			// 
			// labelContent
			// 
			...
			this.labelContent.Size = new System.Drawing.Size(424, 58);
			this.labelContent.TabIndex = 3;
			this.labelContent.Text = "현재까지의 학습 내용이 저장되지 않습니다.\r\n계속 학습을 하려면 [CANCEL] 버튼을 눌러주세요.";
			// 
			// btnOk
			// 
