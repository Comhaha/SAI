...
{
	partial class DialogCompleteLabeling
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// panelTitleBar
			// 
			this.panelTitleBar.BackgroundImage = global::SAI.Properties.Resources.bg_blue_titlebar;
			...
			this.labelContent.Size = new System.Drawing.Size(505, 58);
			this.labelContent.TabIndex = 3;
			this.labelContent.Text = "라벨링 단계의 TO DO LIST를 모두 완수하였습니다.\r\n[모델 학습하러 가기] 버튼을 누르면 다음 단계로 이동합니다.\r\n";
			// 
			// btnLearnModel
			// 
			...
			this.BackgroundImage = global::SAI.Properties.Resources.bg_dialog_white_667_282;
